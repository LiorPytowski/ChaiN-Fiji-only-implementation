...
for (i = 0; i < lengthOf(filelist_processed_inputs); i++) {
	...
	nb_neighbours = 2;
	run("DiAna_Analyse", "img1=" + Image_final_label_centroids + " img2=" + name_classified_nuclei + " lab1=" + Image_final_label_centroids + " lab2=" + name_classified_nuclei + " adja kclosest=" + nb_neighbours);
